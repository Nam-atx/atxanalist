        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body1">
                  ...
                  <form class="form-inline" action="{{route('rm.employment.yearresume')}}">
                  ...
                  <form action="{{route('rm.employment.yearresume')}}" class="form-inline reset"><button class="btn btn-primary" type="submit">Reset</button>
                  </form>
