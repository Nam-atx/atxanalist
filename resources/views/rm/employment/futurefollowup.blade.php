        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body1">
                  ...
                  @endif 
                  <form class="form-inline" action="{{route('rm.futurefollowup')}}">
                  ...
                  <form action="{{route('rm.futurefollowup')}}" class="form-inline reset"><button class="btn btn-primary" type="submit">Reset</button>
                  </form>
