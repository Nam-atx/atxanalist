...
<div class="justify-content-center">
	<div class="col-md-12">
	    <div class="card">
	        <div class="card-header">Client Add</div>
	        <div class="card-body">
	        	<form class="form-horizontal" method="post" action="{{route('sales.client.store')}}" name="user_add_validate" id="user_add_validate">
              {{ csrf_field() }}
             ...
             <div class="control-group">
              ...
              <label class="control-label">Opening Date</label>
                <div class="controls {{ $errors->has('opening_date') ? ' is-invalid' : '' }}">
                  <input type="text" name="opening_date" id="opening_date-required" value="{{ old('opening_date') }}" >
