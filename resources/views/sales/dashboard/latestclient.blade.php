        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body1">
                  ...
                  <form class="form-inline" action="{{route('sales.dashboard.latestclient')}}"><div class="form-group"><input class="form-control" type="text" name="name" placeholder="Name" value="{{ app('request')->input('name') }}"></div>
