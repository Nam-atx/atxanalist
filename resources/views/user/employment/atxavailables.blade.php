        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body1">
                  ...
                  <form class="form-inline" action="{{route('emp.atxavailables')}}">
                  ...
                  <form action="{{route('emp.atxavailables')}}" class="form-inline reset"><button class="btn btn-primary" type="submit">Reset</button>
                  </form>
                      ...
                      <tbody>
                       ...
                       <tr>
                          <td>{{ \Carbon\Carbon::parse($employment->application_date)->format('F d, Y') }}</td>
                            ...
                            <td><a href="{{route('emp.show',$employment->id)}}?empstatus=available&position={{app('request')->input('position')}}&city={{app('request')->input('city')}}&state={{app('request')->input('state')}}&radius={{app('request')->input('radius')}}&email={{app('request')->input('email')}}&from_date={{app('request')->input('from_date')}}&to_date={{app('request')->input('to_date')}}">{{$employment->first_name}}</a></td>
